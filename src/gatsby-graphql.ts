...
export type GetAllPostsQuery = { allMarkdownRemark: { edges: Array<{ node: { id: string, frontmatter?: { title?: string | null | undefined, date?: any | null | undefined } | null | undefined } }> } };
